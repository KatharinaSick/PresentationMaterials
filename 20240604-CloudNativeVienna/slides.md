...
Kubernetes, Community, and the Joy of Developer Experience
...
<img src="/landscape.png" alt="CNCF Landscape" style="position:absolute; width: 100%; left: 0; top: 0" />
...
<a style="font-size: 12px; margin-top: 8px" target="_blank" href="https://youtu.be/zgxdq3O-atE?si=GdpU7MBRZdd_tuN4">Introduction to<br/>Developer Platforms</a>
</div>
...
📢️ Join a Technical Advisory Group (TAG)

✨ Create or join a community group
</v-clicks>

<div style="position: absolute; width: 200px; top:370px; right: 0; display: flex; align-items: center; justify-content: center; flex-direction: column">
<img style="height: 80px; width: 80px" src="/qr-contribute-to-cncf.svg" alt="QR Code"/>
<a style="font-size: 12px; margin-top: 8px; text-align: center" target="_blank" href="https://contribute.cncf.io/contributors/">CNCF: Contribute to<br/>the CNCF Ecosystem</a>
</div>
---
layout: center
---
